...
def build_preprocessor(numeric_cols, skewed_cols, categorical_cols, ordinal_cat_col):
    ...
    and scaling specifications used during the Model training phase.
    """
    ...
    ('ordinal_cat',    OrdinalEncoder(categories=[['Month-to-month', 'One year', 'Two year']], handle_unknown='use_encoded_value', unknown_value=-1), ordinal_cat_col)], remainder='drop')
